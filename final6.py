...
def calculate_metrics(stats, packets, predicted_labels, true_labels):
    ...
    # Calculate fast_model_count as total_packets - slow_model_count
    fast_model_count = total_packets - stats['slow_model_count']
    ...
    print(f"Packets Processed by Fast Model: {fast_model_count}")
